...
export class SLAService {
  ...
  async getMetrics(criteria: SLAMetricsCriteria, context: AuthContext): Promise<SLAMetrics> {
    ...
    return {
      ...
      byPriority: {
        Critical: { total: 0, breached: 0, compliancePercentage: 100 },
        High: { total: 0, breached: 0, compliancePercentage: 100 },
        Medium: { total: 0, breached: 0, compliancePercentage: 100 },
        Low: { total: 0, breached: 0, compliancePercentage: 100 }
      },
      byCategory: {}
    };
  }
